...
export const ar: Dictionary = {
  ...
  ui: {
    ...
    youtubeCtaBody:
      "وإذا كنت تريد متابعة جميع فيديوهاتنا الكارتونية وحلقاتنا على اليوتيوب اضغط على اللينك، ونود منك المشاركة وعلامة اللايك.",
  ...
  profile: {
    ...
    philosophy: [
      ...
      {
        title: "منتج لا مجرد كود",
        body: "المعيار هو منتج قابل للاستخدام في الإنتاج، لا مكوّنات معزولة.",
      },
    ...
    experience: [
      ...
      },
      {
        ...
        kind: "earlier",
        summary: "خبرة تشغيلية سابقة رسّخت تحسين العمليات والتخطيط والتنسيق وحل المشكلات المنظّم.",
      },
    ],
    education: [
      {
  ...
  projects: [
    ...
    },
    {
      ...
      role: "المعماري والمهندس الوحيد",
      scope: "تصميم المنتج والواجهة والخلفية ونموذج البيانات والنشر",
      disciplines: ["هندسة متكاملة", "تصميم المنتج", "معمارية الواجهة الخلفية", "تمثيل البيانات"],
      summary:
    ...
    },
    {
      ...
      role: "المعماري والمهندس الوحيد",
      scope: "تصميم المنتج والواجهة والخلفية ونموذج البيانات والنشر",
      disciplines: ["هندسة متكاملة", "معمارية الواجهة الخلفية", "تصميم المنتج", "نمذجة البيانات"],
      summary:
    ...
    },
    {
      ...
      disciplines: ["هندسة الذكاء الاصطناعي", "DevSecOps", "هندسة Full-Stack", "تصميم المنتج"],
      summary:
  ...
  factory: {
    ...
    what: "المصنع منصة هندسة برمجيات بالذكاء الاصطناعي. يأخذ متطلبًا برمجيًا منظمًا ويمرّره عبر مسارات توليد وتحقق وتسليم متخصصة حتى يصبح نظامًا متماسكًا لا مجرد أجزاء كود.",
    problem:
    ...
    capabilities: [
      ...
      {
        title: "معمارية قائمة على العقود",
        body: "تُنتج المعمارية والواجهات أولًا لتستهدف كل الطبقات العقود نفسها.",
      },
      {
        title: "مصانع متخصصة",
        body: "تُولَّد طبقات الخلفية والواجهة وقواعد البيانات والذكاء الاصطناعي بمسارات مخصصة.",
      },
      { title: "مسارات التحقق", body: "تمر المخرجات ببوابات تحقق وجودة قبل اعتبارها مكتملة." },
      {
        title: "بنية التسليم",
        body: "الحاويات وبنية النشر جزء من المخرجات وليست خطوة يدوية منفصلة.",
      },
    ],
    categories: [
      "تطبيقات ويب للأعمال",
    ...
    quality: [
      {
        title: "التحقق من العقود",
        body: "تُفحص الطبقات المُولَّدة مقابل عقود المعمارية التي بُنيت عليها.",
      },
