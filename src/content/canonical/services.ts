...
export const services: CanonicalService[] = [
  {
    ...
    capabilities: {
      en: ["ASP.NET Core services", "REST API design", "Data modelling with EF Core"],
      ar: null,
    },
    deliverables: { en: ["Backend service", "API contract", "Deployment setup"], ar: null },
    idealFor: {
      en: ["Products needing a reliable backend", "Teams replacing an ad-hoc API"],
      ar: null,
    },
  ...
  },
  {
    ...
    summary: {
      en: "End-to-end web applications with React, TypeScript and a .NET or Python backend.",
      ar: null,
    },
    description: {
      en: "Building complete web applications from data model to interface, including state management, routing and deployment.",
      ar: null,
    },
    capabilities: {
      en: [
        ...
        "Backend integration",
        "Responsive, bilingual interfaces",
      ],
      ar: null,
    },
  ...
  },
  {
    ...
    description: {
      en: "Integration of language models into existing products: prompt and response handling, structured outputs, and service boundaries around the model.",
      ar: null,
    },
    capabilities: {
      en: ["LLM integration", "Structured output handling", "AI service boundaries"],
      ar: null,
    },
  ...
  },
  {
    ...
    description: {
      en: "Design and implementation of agent workflows and automation pipelines that orchestrate steps across services.",
      ar: null,
    },
    capabilities: {
      en: ["Agent workflows", "Task orchestration", "Automation pipelines"],
      ar: null,
    },
  ...
  },
  {
    ...
    description: {
      en: "API design and implementation: resource modelling, contracts, versioning and documentation.",
      ar: null,
    },
  ...
  },
  {
    ...
    description: {
      en: "Architecture work: system decomposition, service boundaries, data flow and deployment topology.",
      ar: null,
    },
    capabilities: {
      en: ["System decomposition", "Service boundaries", "Deployment topology"],
      ar: null,
    },
  ...
  },
  {
    ...
    description: {
      en: "Taking a product idea through scoping, architecture, implementation and deployment as a working digital product.",
      ar: null,
    },
    capabilities: {
      en: ["Product scoping", "Implementation", "Deployment and iteration"],
      ar: null,
    },
