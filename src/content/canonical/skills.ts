...
export const skillGroups: SkillGroup[] = [
  {
    ...
    skills: [
      skill("backend", { name: "C#", context: "Primary backend language.", emphasis: "primary", featured: true }),
      skill("backend", { name: ".NET", context: "Runtime and framework for backend services.", emphasis: "primary", featured: true }),
      skill("backend", { name: "ASP.NET Core", context: "Used to build HTTP services and APIs.", emphasis: "primary", featured: true }),
      skill("backend", { name: "Entity Framework Core", context: "Data access and migrations in .NET services.", emphasis: "primary" }),
      skill("backend", { name: "REST APIs", context: "Designing and implementing resource-based HTTP APIs.", emphasis: "primary", featured: true }),
      skill("backend", { name: "API Architecture", context: "Contracts, versioning and service boundaries.", emphasis: "primary" }),
    ],
  },
  {
    id: "frontend",
    ...
    skills: [
      skill("frontend", { name: "TypeScript", context: "Default language for web application code.", emphasis: "primary", featured: true, source: "project-documentation" }),
      skill("frontend", { name: "JavaScript", context: "Used where TypeScript is not in place.", }),
      skill("frontend", { name: "React", context: "Component model used across web projects.", emphasis: "primary", featured: true, source: "project-documentation" }),
      skill("frontend", { name: "Vite", context: "Build tooling for web applications.", source: "project-documentation" }),
      ...
      skill("frontend", { name: "Tailwind CSS", context: "Utility-first styling in current web projects.", emphasis: "primary", source: "project-documentation" }),
  ...
  },
  {
    ...
    skills: [
      skill("mobile", { name: "Flutter", context: "Cross-platform mobile application development.", emphasis: "primary", featured: true }),
      skill("mobile", { name: "Dart", context: "Language used with Flutter.", emphasis: "primary" }),
    ],
  },
  {
    id: "ai",
    ...
    skills: [
      skill("ai", { name: "Python", context: "Used for AI services and tooling.", emphasis: "primary", featured: true }),
      skill("ai", { name: "FastAPI", context: "HTTP layer for Python AI services.", emphasis: "primary" }),
      skill("ai", { name: "LLM integrations", context: "Language models integrated into product flows.", emphasis: "primary", featured: true, source: "project-documentation" }),
...

  {
    ...
    skills: [
      skill("databases", { name: "SQL Server", context: "Relational database used with .NET services.", emphasis: "primary" }),
      skill("databases", { name: "PostgreSQL", context: "Relational database used in current projects.", emphasis: "primary", featured: true }),
      skill("databases", { name: "Entity Framework Core", context: "ORM and migrations layer.", emphasis: "primary" }),
  ...
  },
  {
    ...
    skills: [
      skill("devops", { name: "Docker", context: "Containerizing services for deployment.", emphasis: "primary", featured: true, source: "project-documentation" }),
      skill("devops", { name: "Linux", context: "Host environment for deployed services.", emphasis: "primary" }),
      skill("devops", { name: "NGINX", context: "Reverse proxy and TLS termination.", emphasis: "primary", source: "project-documentation" }),
      skill("devops", { name: "Git", context: "Version control for all work.", emphasis: "primary" }),
      skill("devops", { name: "GitHub", context: "Repository hosting and collaboration." }),
      skill("devops", { name: "HTTPS / SSL", context: "Certificates and secure transport for public endpoints." }),
      skill("devops", { name: "Reverse Proxy", context: "Routing public traffic to internal services." }),
      skill("devops", { name: "Deployment", context: "Releasing and operating services in production." }),
    ],
  },
  {
    id: "languages",
    ...
    description: { en: "Additional languages and environments used outside the core stack.", ar: null },
    skills: [
